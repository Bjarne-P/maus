...
public class AddressbookActivity extends AppCompatActivity {
	...
	protected static String logger = AddressbookActivity.class.getSimpleName();
	...
	private void processDeleteContact(final Contact contact) {
		...
		new AsyncTask<Void, Void, Boolean>() {
			...
			protected Boolean doInBackground(Void... params) {
				return AddressbookActivity.this.accessor.deleteContact(contact);
			}

			@Override
			protected void onPostExecute(Boolean deleted) {
				if (deleted) {
					Toast.makeText(AddressbookActivity.this, "Der Eintrag " + contact.getName() + " wurde gelöscht.",
	...
	private void initContacts() {
		...
		new AsyncTask<Void, Void, List<Contact>>() {
			...
			protected List<Contact> doInBackground(Void... params) {
				return AddressbookActivity.this.accessor.readAllContacts();
			}
			...
			protected void onPostExecute(List<Contact> contacts) {
				...
				AddressbookActivity.this.contactsList.addAll(contacts);
				AddressbookActivity.this.contactsListAdapter.notifyDataSetChanged();
			}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if ((requestCode == REQUEST_CREATE_ENTRY || resultCode == AddressbookEntryActivity.RESULT_CODE_EDITED)
			...
			new AsyncTask<Void, Void, Boolean>() {
				...
				@Override
				protected Boolean doInBackground(Void... params) {
					return AddressbookActivity.this.accessor.createContact(newContact);
				}
